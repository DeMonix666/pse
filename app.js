...
if (!module.parent) {
    ...
    console.log(process.version+' listening on port '+(process.env.PORT||3001)+' ('+app.env+'/'+db+')');
}
...
app.io.use(handlebars({
    extension:   ['html', 'handlebars'],
    viewsDir:    'apps/www',
    partialsDir: 'apps/www/views',
    helpers: require("./apps/www/lib/helpers.js")
}));
